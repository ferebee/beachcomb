...
from core import Planner, VERSION
...
def main():
    ...
    ap.add_argument("--move", action="store_true", help="Move instead of copy (dangerous until you trust the plan).")
    ap.add_argument("--rename", choices=["none","all","photorec"], default="photorec", help="Content-aware file renaming policy (default photorec).")
    args = ap.parse_args()
    ...
    log(f"beachcomb v{VERSION} starting up...")
